#!/usr/bin/env python
########################################################################################################
# Name:  PAC_IRF_CLMS.py
#
# Desc: Script to Extract Inpatient Rehabilitation Facility(IRF) Claims Data
#
...
try:
   ...
   #**************************************
   #   Extract Inpatient Rehabilitation Facility(IRF) Claims Data
   #**************************************   
   snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_PAC_STG/PAC_IRF_CLMS_Y{FYQ}_{TMSTMP}.csv.gz
                                                FROM (
SELECT
 DISTINCT       
