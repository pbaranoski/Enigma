...
#         (legacy A4A report)  
# Run Command:	1. Option 1: script parameter is calculated based on the biannual run date:Jan, Jul. 
#			./STS_HHA_A4A.sh
#		2. Option 2: parameter passed from command line for Jan or Jul. 
#			./STS_HHA_A4A.sh YYYY-01-01   #extract for Jan to Dec
#			./STS_HHA_A4A.sh YYYY-07-01   #extract for Jul to Jun
#
...
LOGNAME=/app/IDRC/XTR/CMS/logs/STS_HHA_A4A_${TMSTMP}.log
RUNDIR=/app/IDRC/XTR/CMS/scripts/run/
DATADIR=/app/IDRC/XTR/CMS/data/
RPTNAME="STS HHA A4A "
SHELL_SCRIPT=`basename ${BASH_SOURCE}`
PYTHON_SCRIPT="STS_HHA_A4A.py"
