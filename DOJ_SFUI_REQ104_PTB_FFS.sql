COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ104_FFS_PTB_Y2016_20250918.1027001.csv.gz
   FROM (

	WITH FF AS (

		SELECT NPI_NUM
		FROM BIA_PRD.CMS_TARGET_XTR_PRD.DOJ_REQ104_FF
	)    

	,CLMS_2_SELECT AS (

		-- 1) Get all Claims where at least one of the Claim lines on the claim has REV_CTR_CD = '0278'
		-- 2) The Claim must also have one of the NPI numbers on the FF referenced on the claim
		SELECT DISTINCT C.GEO_BENE_SK, C.CLM_DT_SGNTR_SK, C.CLM_TYPE_CD, C.CLM_NUM_SK, C.CLM_FROM_DT
		...
		AND CL.CLM_LINE_HCPCS_CD IN ('23470','23472','23473','23474','27091','27130','27132','27134','27137','27138',
		                             '27447','27486','27487','27488','27700','27702','27703','20690','20692' )
		...
		-- Get all claims and Claim lines for the claims on the CLMS_2_SELECT View
          ...
          SELECT 
             ...
             ,'END'
				...
				INNER JOIN CLMS_2_SELECT C2S
				ON  C.GEO_BENE_SK       = C2S.GEO_BENE_SK
				AND C.CLM_DT_SGNTR_SK   = C2S.CLM_DT_SGNTR_SK 
				AND C.CLM_TYPE_CD       = C2S.CLM_TYPE_CD
				AND C.CLM_NUM_SK        = C2S.CLM_NUM_SK 
				AND C.CLM_FROM_DT       = C2S.CLM_FROM_DT
	...
	FILE_FORMAT = (TYPE = CSV field_delimiter = "|"  ESCAPE_UNENCLOSED_FIELD=NONE )
