COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ102_EYLEA_PTA_20260108.120000.txt.gz FROM (
   ...
   SELECT 
	  ...
	  ,CASE WHEN SUBSTR (CLM_CNTL_NUM,14,1) = '0'
	        -- Unknown
	        THEN ' '
	        WHEN SUBSTR (CLM_CNTL_NUM,14,1) = '1'
			-- 'EMC/UB92/HCFA (Electronic - Pre-HIPAA)'
            THEN 'X'
	        WHEN SUBSTR (CLM_CNTL_NUM,14,1) = '2'	
			-- -- 'EMC Tape/UB92/Other (Electronic - Pre-HIPAA)'	
			THEN 'X'
	        WHEN SUBSTR (CLM_CNTL_NUM,14,1) = '3'	
			-- 'EMC Tape/Other (Other is defined as PRO Automated adjustment for FISS) (Electronic - Pre-HIPAA)'
			THEN 'X'			
	        WHEN SUBSTR (CLM_CNTL_NUM,14,1) = '4'
            -- 'EMC Telecom/UB92 (DDE Claim) (Electronic - Pre-HIPAA)'			
			THEN 'X'			
	        WHEN SUBSTR (CLM_CNTL_NUM,14,1) = '5'			
			-- 'EMC Telecom/UB92 (Not UB92) (Electronic - Pre-HIPAA)'
			THEN 'X'			
	        WHEN SUBSTR (CLM_CNTL_NUM,14,1) = '6'
			-- 'Other EMC/UB92 (Electronic Pre-HIPAA)'
			THEN 'X'			
	        WHEN SUBSTR (CLM_CNTL_NUM,14,1) = '7'
			-- 'Other EMC/Not UB92 (Electronic)'
			THEN 'X'			
	        WHEN SUBSTR (CLM_CNTL_NUM,14,1) = '8'
			-- 'UB04 Hardcopy (Paper)'
			THEN 'P'			
	        WHEN SUBSTR (CLM_CNTL_NUM,14,1) = '9'
			-- 'Other Hardcopy (Paper - OCR)'
			THEN 'P'
			ELSE ' '
