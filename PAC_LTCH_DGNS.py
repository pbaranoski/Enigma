#!/usr/bin/env python
########################################################################################################
# Name:  PAC_LTCH_DGNS.py
#
# Desc: Script to Extract Long Term Care Hospital(LTCH) Diagnosis Data
#
...
try:
   ...
   #**************************************
   #   Extract Long Term Care Hospital(LTCH) Diagnosis Data
   #**************************************   
   snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_PAC_STG/PAC_LTCH_DGNS_Y{FYQ}_{TMSTMP}.csv.gz
                                                FROM (
SELECT DISTINCT    
