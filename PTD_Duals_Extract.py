#!/usr/bin/env python
########################################################################################################
# Name:  PTD_Duals_extract.py
#
# Desc: Part D Duals data Extract
#
# Created: Paul Baranoski 12/12/2022
# Modified:
#
...
SNOWFLAKE_STG=os.getenv('SNOWFLAKE_STG')
...
try:
   ...
   #**************************************   
   snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_{SNOWFLAKE_STG}/{S3_EXTRACT_FILE}
                                                FROM (                                                               
