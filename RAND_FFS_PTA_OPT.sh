...
#
# Modified:
# Joshua Turner 	2023-02-28	New script.
...
echo "" >> ${LOGNAME}
echo "Python script RAND_FFS_PartA_Extract.py completed successfully for OPT. " >> ${LOGNAME}
...
###########################################################################################
echo "" >> ${LOGNAME}
echo "RAND_FFS_PTA_OPT.sh completed successfully." >> ${LOGNAME}
