COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_FOIA_STG/FOIA_SFUI_REQ110_2_MulticareDryer_MA_PTA_ALL_20250910.120000.txt.gz
                                                FROM ( 
...
,CLM_ENC_CLMS AS (
	...
	AND C.CLM_TYPE_CD IN (4011, 4012, 4013, 4041, 4043)                
...
,TMP_INP_ADR AS (
  ...
  WHERE C.CLM_TYPE_CD IN (4011, 4012, 4013, 4041, 4043)
