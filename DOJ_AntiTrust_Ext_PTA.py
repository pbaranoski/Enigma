#!/usr/bin/env python
########################################################################################################
# Name:  DOJ_AntiTrust_Ext_PTA.py
#
# Desc: DOJ AntiTrust Extract PTA SQL
#
# Created: Paul Baranoski 11/6/2023
# Modified:
#
# Paul Baranoski 2023-11-06 Anti-Trust Extract
# Paul Baranoski 2023-12-28 Modify SQL for new requirements that include PII and CLM_UNIQ_ID.
# Nat. Tinovsky  2025-01-08 Increase length for PRVDR_LGL_NAME
# Paul Baranoski 2025-02-11 Add 5 additional fields to results set. Comment out the state and county filters.
########################################################################################################
import os
import sys
import datetime
