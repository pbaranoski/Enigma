...
COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ102_EYLEA_PTB_DME_20260108.120000.txt.gz FROM (

WITH VMS_CLMS AS (

		SELECT CLM_CNTL_NUM, CLM_SBMT_FRMT_CD
		...
		OR CL.CLM_LINE_NDC_CD IN ('61755000501','61755000502','61755000554','61755000555'))
          ...
          SELECT 
			 ...
			 ,VC.CLM_SBMT_FRMT_CD	AS CLM_SUBMTR_FORM_IND	
             ...
             ,'END'
			    ...
			    INNER JOIN VMS_CLMS VC
                ON VC.CLM_CNTL_NUM = ('1'||C.CLM_CNTL_NUM)				

		-- Separate queries for Carrier vs DME
		WHERE C.CLM_TYPE_CD IN (81,82)
		AND C.CLM_FINL_ACTN_IND = 'Y'
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2013-01-01','YYYY-MM-DD') AND TO_DATE('2014-12-31','YYYY-MM-DD')
