...
try:
    ...
    print(f"Before Executing SQL DUALS_MedAdv AH-{EXT_ST} Extract")

    #**************************************
    #   Extract NYSPAP Bene Contract data  
    #**************************************                         
    snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_DUALS_MA_STG/DUALS_MedAdv_AH_{EXT_ST}_{CLM_PRD}_{TMSTMP}.txt.gz
                                                FROM (                                                               
    ...
    print(f"Before Executing SQL DUALS_MedAdv AL-{EXT_ST} Extract")

  
    snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_DUALS_MA_STG/DUALS_MedAdv_AL_{EXT_ST}_{CLM_PRD}_{TMSTMP}.txt.gz
                                                FROM (                                                               
