...
try:
   ...
   #**************************************   
   snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_PSA_STG/PSA_ASC_{YYYY}_{TMSTMP}.csv.gz
                                                FROM (
                    ...
                    SELECT *
                      FROM (
                            ...
                            SELECT BZ5.GEO_ZIP5_CD        AS Bene_ZIP_CD
                             --      ,HCPCS.CAT_CD          AS CAT_CD
                                   ,HCPCS.CAT_DESC        AS CAT_DESC
                            ...
                            INNER JOIN BIA_{ENVNAME}.CMS_TARGET_XTR_{ENVNAME}.PSA_HCPCS_APC_CAT_FF  HCPCS
                        ...
                        WHERE C.CLM_FINL_ACTN_IND = 'Y'
                          ...
                          AND CLP.CLM_PRVDR_SPCLTY_CD  = '49'
                          AND (CL.HCPCS_1_MDFR_CD NOT IN ('51','54','55','56') 
                               OR 
                               CL.HCPCS_2_MDFR_CD NOT IN ('51','54','55','56')) 
                            
                        GROUP BY BZ5.GEO_ZIP5_CD, HCPCS.CAT_DESC
                        --ORDER BY Bene_ZIP_CD, HCPCS.CAT_DESC
                    ...
                    PIVOT(MAX(CHRG_AMT) FOR CAT_DESC IN ({PIV_COL_DESC_LIST})) AS P
