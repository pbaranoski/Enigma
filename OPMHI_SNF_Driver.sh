#!/usr/bin/bash
############################################################################################################
# Script Name: OPMHI_SNF_Driver.sh
# Description: This script executes the Part A SQL python script for OPM-HI SNF 
#
...
CUR_DT=`date +%Y%m%d`
LOGNAME=/app/IDRC/XTR/CMS/logs/OPMHI_SNF_Driver_${TMSTMP}.log
...
echo "################################### " >> ${LOGNAME}
echo "OPMHI_SNF_Driver.sh started at `date` " >> ${LOGNAME}
echo "" >> ${LOGNAME}
...
S3BUCKET=${OPMHI_SNF_BUCKET}

#################################################################################
# Clean linux data directory of any residual files
#################################################################################
echo "" >> ${LOGNAME}
echo "Remove any residual FEHB_CMS_SNF_* files on linux data directory" >> ${LOGNAME}
rm ${DATADIR}FEHB_CMS_SNF_*   2>> ${LOGNAME}
...
echo "" >> ${LOGNAME}
echo "OPM-HI SNF Extract is starting with the following parameters:" >> ${LOGNAME}
...
#################################################################################
# Execute Python code to produce SNF file
#################################################################################
echo "" >> ${LOGNAME}
...
#################################################################################
echo "" >> ${LOGNAME}
echo "OPMHI_SNF_Driver.sh completed successfully." >> ${LOGNAME}
