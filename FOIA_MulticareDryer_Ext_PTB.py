#!/usr/bin/env python
########################################################################################################
# Name:  FOIA_MulticareDryer_Ext_PTB.py
#
# Desc: FOIA Multicare Dryer Extract PTB SQL
#
# Modified:
#
# Paul Baranoski 2025-08-01 Created Extract
# Paul Baranoski 2025-08-19 Change date filter from Submission Date to CLM_THRU_DT.
########################################################################################################
import os
import sys
import datetime
...
try:
   ...
   #**************************************   
   snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_FOIA_STG/FOIA_MulticareDryer_EXTRACT_{CLM_TYPE_LIT}_{FILE_LIT}_{TMSTMP}.txt.gz
                                                FROM (
