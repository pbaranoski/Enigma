...
#
######################################################################################
# Name:  DEMOFNDR_PTD.sh
#
# Desc: Performs Extract of PartD data. 
#
...
LOGNAME=/app/IDRC/XTR/CMS/logs/DEMOFNDR_PTD_Extract_${TMSTMP}.log
...
echo "################################### " >> ${LOGNAME}
echo "DEMOFNDR_PTD.sh started at `date` " >> ${LOGNAME}
echo "" >> ${LOGNAME}
...
############################################
# Execute DEMOFNDR Part D Extract
############################################
echo " " >> ${LOGNAME}
echo "Extract processing. " >> ${LOGNAME}
${PYTHON_COMMAND} ${RUNDIR}DEMOFNDR_PTD.py  >> ${LOGNAME} 2>&1
...
if [[ $RET_STATUS != 0 ]]; then
        echo "" >> ${LOGNAME}
        echo "Python script DEMOFNDR_PTD.py failed." >> ${LOGNAME}
