#!/usr/bin/env python
########################################################################################################
# Name:  PAC_HOSP_DGNS.py
#
# Desc: Script to Extract Hospice Diagnosis Data
#
...
try:
   ...
   #**************************************
   #   Extract Hospice Diagnosis Data
   #**************************************   
   snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_PAC_STG/PAC_HOSP_DGNS_Y{FYQ}_{TMSTMP}.csv.gz
                                                FROM (
