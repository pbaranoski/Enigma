COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ173_EYLEA_PTB_CAR_20260629.120000.txt.gz FROM (
		...
		-- 2024 and 2025
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2024-01-01','YYYY-MM-DD') AND TO_DATE('2025-12-31','YYYY-MM-DD')
