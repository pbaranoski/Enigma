#!/usr/bin/bash
############################################################################################################
# Script Name: OPMHI_HSP_Driver.sh
# Description: This script executes the Part A SQL python script for OPM-HI HSP 
#
...
echo "################################### " >> ${LOGNAME}
echo "OPMHI_HSP_Driver.sh started at `date` " >> ${LOGNAME}
echo "" >> ${LOGNAME}
...
S3BUCKET=${OPMHI_HSP_BUCKET}

#################################################################################
# Clean linux data directory of any residual files
#################################################################################
echo "" >> ${LOGNAME}
echo "Remove any residual FEHB_CMS_HOS_* files on linux data directory" >> ${LOGNAME}
rm ${DATADIR}FEHB_CMS_HOS_*   2>> ${LOGNAME}
...
echo "" >> ${LOGNAME}
echo "OPM-HI HSP Extract is starting with the following parameters:" >> ${LOGNAME}
...
#################################################################################
# Execute Python code to produce HOS file
#################################################################################
echo "" >> ${LOGNAME}
...
#################################################################################
echo "" >> ${LOGNAME}
echo "OPMHI_HSP_Driver.sh completed successfully." >> ${LOGNAME}
