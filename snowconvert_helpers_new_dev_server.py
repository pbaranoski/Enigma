...
# </copyright>
#
# 06/12/2026 Paul Baranoski  Remove code that does not pertain to XTR.
#
...
def log_on(sf_logon_file = None):
    ...
    elif stream_upper == 'NCPDP':
        secret_stream_lower="prvdr"
    elif stream_upper == 'BENEMBD':
        secret_stream_lower="bene"
    else:
        secret_stream_lower=stream_lower
...
def assume_role(sf_logon_file = None):
    ...
    if acct_val:
        print(f'IDRC_DATALAKE_AWS_ACCT =  {acct_val}')
    else:
    ...
    elif stream_upper == 'ACO': 
        stream_role_arn=stream_role_arn_prefix+"idrc-infa-om-etl-aco-fat-role"
    elif stream_upper == 'BENEMBD': 
        stream_role_arn=stream_role_arn_prefix+"idrc-infa-om-etl-bene-role"
    elif stream_upper == 'PECOSGEF': 
        stream_role_arn=stream_role_arn_prefix+"idrc-infa-om-etl-pecos-gef-role"
    elif stream_upper == 'PECOSNSC': 
        stream_role_arn=stream_role_arn_prefix+"idrc-infa-om-etl-pecos-nsc-role"
    elif stream_upper == 'BENEFCT': 
        stream_role_arn=stream_role_arn_prefix+"idrc-infa-om-etl-bene-fct-role"
    ...
    elif stream_upper == 'CNTRCT': 
        stream_role_arn=stream_role_arn_prefix+"idrc-infa-om-etl-cntrct-frmlry-role"
    else:
