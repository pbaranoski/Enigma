#!/usr/bin/env python
########################################################################################################
# Name:  DOJ_Pistarino_Ext_PTA.py
#
# Desc: DOJ Pistarino Extract PTA SQL
#
# Created: Paul Baranoski 02/28/2024
# Modified:
#
# Paul Baranoski 2024-03-28 Pistarino Extract
# Paul Baranoski 2024-05-29 Change filter to use CLM_SUBMSN_DT. Change to use FOIA stage and filename.
# Nat. Tinovsky  2025-01-09 Increase PRVDR_LGL_NAME from 70 to 100
########################################################################################################
import os
import sys
import datetime
