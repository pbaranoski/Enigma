...
# Name:  PAC_SNF_RC.py
#
# Desc: Script to Extract Skilled Nursing Facility(SNF) Revenue Center Data
#
...
try:
   ...
   #**************************************
   #   Extract Skilled Nursing Facility(SNF) Revenue Center Data
   #**************************************   
   snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_PAC_STG/PAC_SNF_RC_Y{FYQ}_{TMSTMP}.csv.gz
                                                FROM (
SELECT   
DISTINCT    
