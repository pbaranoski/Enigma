...
# Name:  PAC_SNF_PC.py
#
# Desc: Script to Extract Skilled Nursing Facility(SNF) Procedure Code Data
#
...
try:
   ...
   #**************************************
   #   Extract SNF Procedure Code Data
   #**************************************   
   snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_PAC_STG/PAC_SNF_PC_Y{FYQ}.{TMSTMP}.csv.gz
                                                FROM (
SELECT 
DISTINCT 
