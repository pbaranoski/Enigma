...
--1)  DELETE FROM BIA_{ENVNAME}.CMS_TARGET_XTR_{ENVNAME}.CLM_FMRD

DELETE FROM BIA_{ENVNAME}.CMS_TARGET_XTR_{ENVNAME}.CLM_FMRD

--2)  First INSERT INTO BIA_{ENVNAME}.CMS_TARGET_XTR_{ENVNAME}.CLM_FMRD (scroll down until you see Second INSERT

--***************************************************************
--* FIRST Insert Statement INTO BIA_{ENVNAME}.CMS_TARGET_XTR_{ENVNAME}.CLM_FMRD 
--***************************************************************

INSERT INTO BIA_{ENVNAME}.CMS_TARGET_XTR_{ENVNAME}.CLM_FMRD
...
--***************************************************************
--* Second Insert Statement INTO BIA_{ENVNAME}.CMS_TARGET_XTR_{ENVNAME}.CLM_FMRD 
--***************************************************************
INSERT INTO BIA_{ENVNAME}.CMS_TARGET_XTR_{ENVNAME}.CLM_FMRD
