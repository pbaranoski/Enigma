COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_FOIA_STG/FOIA_SFUI_REQ110_2_MulticareDryer_MA_DME_ALL_20250910.120000.txt.gz
                                                FROM ( 
...
,CLM_ENC_CLMS AS (
	...
	AND C.CLM_TYPE_CD IN (4800 )                
   
    AND C.CLM_THRU_DT BETWEEN TO_DATE('2019-07-01','YYYY-MM-DD') AND TO_DATE('2021-03-31','YYYY-MM-DD') 
    --AND C.CLM_THRU_DT BETWEEN TO_DATE('2019-07-01','YYYY-MM-DD') AND TO_DATE('2019-12-31','YYYY-MM-DD') 
