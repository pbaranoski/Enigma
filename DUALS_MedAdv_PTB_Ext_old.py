...
def Execute_SQL(ST):
    ...
    print(f"Before Executing SQL DUALS_MedAdv BH-{ST} Extract" )

    #**************************************
    #   Extract NYSPAP Bene Contract data  
    #**************************************   
    snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_DUALS_MA_STG/DUALS_MedAdv_BH_{ST}_{CLM_PRD}_{TMSTMP}.txt.gz
                                                FROM (                                                               
    ...
    print(f"Before Executing SQL DUALS_MedAdv BL-{ST} Extract" )

    #**************************************
    #   Extract NYSPAP Bene Contract data  
    #**************************************   
    snowconvert_helpers.execute_sql_statement(f"""COPY INTO @BIA_{ENVNAME}.CMS_STAGE_XTR_{ENVNAME}.BIA_{ENVNAME}_XTR_DUALS_MA_STG/DUALS_MedAdv_BL_{ST}_{CLM_PRD}_{TMSTMP}.txt.gz
                                                FROM (                                                               
