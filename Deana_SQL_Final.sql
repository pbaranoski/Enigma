...
WITH CLM_INFO AS (
    ...
    FROM IDRC_PRD.CMS_FCT_CLM_PRD.CLM C --AT(TIMESTAMP => 'Wed, 2 APR 2025 09:20:00 -0700'::timestamp_tz) C    
    
    INNER JOIN IDRC_PRD.CMS_FCT_CLM_PRD.CLM_DT_SGNTR CDS --AT(TIMESTAMP => 'Wed, 2 APR 2025 09:20:00 -0700'::timestamp_tz) CDS
...
,CLM_RLT_OCRNC_SGNTR_MBR_INFO AS (
    ...
    SELECT 
        ...
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 21 THEN CLM_RLT_OCRNC_CD ELSE NULL END)  AS  CLM_RLT_OCRNC_CD_21
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 22 THEN CLM_RLT_OCRNC_CD ELSE NULL END)  AS  CLM_RLT_OCRNC_CD_22
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 23 THEN CLM_RLT_OCRNC_CD ELSE NULL END)  AS  CLM_RLT_OCRNC_CD_23
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 24 THEN CLM_RLT_OCRNC_CD ELSE NULL END)  AS  CLM_RLT_OCRNC_CD_24
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 25 THEN CLM_RLT_OCRNC_CD ELSE NULL END)  AS  CLM_RLT_OCRNC_CD_25
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 26 THEN CLM_RLT_OCRNC_CD ELSE NULL END)  AS  CLM_RLT_OCRNC_CD_26
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 27 THEN CLM_RLT_OCRNC_CD ELSE NULL END)  AS  CLM_RLT_OCRNC_CD_27
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 28 THEN CLM_RLT_OCRNC_CD ELSE NULL END)  AS  CLM_RLT_OCRNC_CD_28
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 29 THEN CLM_RLT_OCRNC_CD ELSE NULL END)  AS  CLM_RLT_OCRNC_CD_29
        ...
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 21 THEN CLM_RLT_OCRNC_DT ELSE NULL END)  AS  CLM_RLT_OCRNC_DT_21
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 22 THEN CLM_RLT_OCRNC_DT ELSE NULL END)  AS  CLM_RLT_OCRNC_DT_22
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 23 THEN CLM_RLT_OCRNC_DT ELSE NULL END)  AS  CLM_RLT_OCRNC_DT_23
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 24 THEN CLM_RLT_OCRNC_DT ELSE NULL END)  AS  CLM_RLT_OCRNC_DT_24
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 25 THEN CLM_RLT_OCRNC_DT ELSE NULL END)  AS  CLM_RLT_OCRNC_DT_25
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 26 THEN CLM_RLT_OCRNC_DT ELSE NULL END)  AS  CLM_RLT_OCRNC_DT_26
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 27 THEN CLM_RLT_OCRNC_DT ELSE NULL END)  AS  CLM_RLT_OCRNC_DT_27
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 28 THEN CLM_RLT_OCRNC_DT ELSE NULL END)  AS  CLM_RLT_OCRNC_DT_28
        ,MAX(CASE WHEN CLM_RLT_OCRNC_SGNTR_SQNC_NUM = 29 THEN CLM_RLT_OCRNC_DT ELSE NULL END)  AS  CLM_RLT_OCRNC_DT_29
...
,CLM_VAL_INFO AS (
    ...
    --COUNT(*)
		...
		,RPAD(REPLACE(COALESCE(CLM.GEO_BENE_SSA_STATE_CD,''),'~',''),2,' ')  AS SSA_STATE_CD
		...
		,TO_CHAR(COALESCE(CLM_TOT_LINE_CNT,0),'FM000')   AS  CLM_TOT_LINE_CNT
	    ...
	    ,TO_CHAR(GEO_BLG_SK,'FM000000000000000000')  AS GEO_BLK_SK
		...
		-- 9(10).9(4)
		,TO_CHAR(COALESCE(C.CLM_SRVC_UNIT_QTY,0),'FM0000000000.0000')  AS  CLM_SRVC_UNIT_QTY
		...
		-- 9(13)
		,TO_CHAR(COALESCE(C.CLM_UNIQ_ID,0),'FM0000000000000')         AS CLM_UNIQ_ID  
		
		-- 9(13)
		,TO_CHAR(COALESCE(C.META_LST_UPDT_SK,0),'FM0000000000000')    AS META_LST_UPDT_SK 

	 	-- 18 bytes
		,TO_CHAR(COALESCE(C.META_LST_UPDT_SRC_SK,0),'FM000000000000000000')   AS META_LST_UPDT_SRC_SK   
		...
		,RPAD(REPLACE(COALESCE(CDN.CLM_DEMO_ETC_ADJSTMT_CD,''),'~',''),1,' ')  AS CLM_DEMO_ETC_ADJSTMT_CD
		...
		,RPAD(REPLACE(COALESCE(CDN.CLM_MCO_1ST_OPTN_CD,''),'~',''),1,' ')   AS  CLM_MCO_1ST_OPTN_CD   
		,RPAD(REPLACE(COALESCE(CDN.CLM_MCO_2ND_OPTN_CD,''),'~',''),1,' ')   AS  CLM_MCO_2ND_OPTN_CD   
        ...
        ,TO_CHAR(COALESCE(CEGS.CLM_EDIT_SGNTR_MBR_CNT,0),'FM0000')  AS CLM_EDIT_SGNTR_MBR_CNT
		...
		,RPAD(REPLACE(COALESCE(CL.CLM_LINE_IDE_NUM,''),'~',''),20,' ') AS CLM_LINE_IDE_NUM
		...
		,RPAD(REPLACE(COALESCE(CLDN.CLM_PA_RP_EXCLSN_CD,''),'~',''),1,' ')            AS CLM_PA_RP_EXCLSN_CD	
		...
		,RPAD(REPLACE(COALESCE(CLI.CLM_REV_PRICNG_IND_CD,''),'~',''),1,' ')   AS CLM_REV_PRICNG_IND_CD
	...
	--*************************************************************
	--* DGNS and PRCDRS ARRAY from PROD_MT
	--*************************************************************		
    ...
    ,RPAD(REPLACE(COALESCE(CLM_DGNS_E_CD,''),'~',''),2,' ')  AS CLM_DGNS_E_CD  
    ...
    ,RPAD(COALESCE(CRCSM.CLM_RLT_COND_CD_30,''),2,' ')  AS CLM_RLT_COND_CD_30
	...
	,RPAD(COALESCE(CROSM.CLM_RLT_OCRNC_CD_21,''),2,' ') AS CLM_RLT_OCRNC_CD_21
	,RPAD(COALESCE(CROSM.CLM_RLT_OCRNC_CD_22,''),2,' ') AS CLM_RLT_OCRNC_CD_22
	,RPAD(COALESCE(CROSM.CLM_RLT_OCRNC_CD_23,''),2,' ') AS CLM_RLT_OCRNC_CD_23
	,RPAD(COALESCE(CROSM.CLM_RLT_OCRNC_CD_24,''),2,' ') AS CLM_RLT_OCRNC_CD_24
	,RPAD(COALESCE(CROSM.CLM_RLT_OCRNC_CD_25,''),2,' ') AS CLM_RLT_OCRNC_CD_25
	,RPAD(COALESCE(CROSM.CLM_RLT_OCRNC_CD_26,''),2,' ') AS CLM_RLT_OCRNC_CD_26
	,RPAD(COALESCE(CROSM.CLM_RLT_OCRNC_CD_27,''),2,' ') AS CLM_RLT_OCRNC_CD_27
	,RPAD(COALESCE(CROSM.CLM_RLT_OCRNC_CD_28,''),2,' ') AS CLM_RLT_OCRNC_CD_28
	,RPAD(COALESCE(CROSM.CLM_RLT_OCRNC_CD_29,''),2,' ') AS CLM_RLT_OCRNC_CD_29
	,RPAD(COALESCE(CROSM.CLM_RLT_OCRNC_CD_30,''),2,' ') AS CLM_RLT_OCRNC_CD_30
	...
	,COALESCE(CROSM.CLM_RLT_OCRNC_DT_21,'10000101')  AS CLM_RLT_OCRNC_DT_21
	,COALESCE(CROSM.CLM_RLT_OCRNC_DT_22,'10000101')  AS CLM_RLT_OCRNC_DT_22
	,COALESCE(CROSM.CLM_RLT_OCRNC_DT_23,'10000101')  AS CLM_RLT_OCRNC_DT_23
	,COALESCE(CROSM.CLM_RLT_OCRNC_DT_24,'10000101')  AS CLM_RLT_OCRNC_DT_24
	,COALESCE(CROSM.CLM_RLT_OCRNC_DT_25,'10000101')  AS CLM_RLT_OCRNC_DT_25
	,COALESCE(CROSM.CLM_RLT_OCRNC_DT_26,'10000101')  AS CLM_RLT_OCRNC_DT_26
	,COALESCE(CROSM.CLM_RLT_OCRNC_DT_27,'10000101')  AS CLM_RLT_OCRNC_DT_27
	,COALESCE(CROSM.CLM_RLT_OCRNC_DT_28,'10000101')  AS CLM_RLT_OCRNC_DT_28
	,COALESCE(CROSM.CLM_RLT_OCRNC_DT_29,'10000101')  AS CLM_RLT_OCRNC_DT_29
	,COALESCE(CROSM.CLM_RLT_OCRNC_DT_30,'10000101')  AS CLM_RLT_OCRNC_DT_30
