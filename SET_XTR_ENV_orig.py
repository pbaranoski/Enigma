...
if  ENVNAME == 'DEV':
    ...
    os.environ["IDRC_DATALAKE_AWS_ACCT"] = "779846826630" --> value when on enigma Dev server
elif ENVNAME == 'TST':
    ...
    #os.environ["IDRC_DATALAKE_AWS_ACCT"] = "203918871088" --> value when on enigma Dev server
