...
--COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ103c_WALMART_PTD_Y2014_20250929.120000.txt.gz FROM (
...
INNER JOIN BIA_PRD.CMS_TARGET_XTR_PRD.REQ103c_WALMART_FF FF
ON SUBSTR(FF.NDC_CD,1,9) = SUBSTR(CL.CLM_LINE_NDC_CD,1,9)
...
ON C.CLM_PRSBNG_PRVDR_GNRC_ID_NUM = PRVDR.PRVDR_NPI_NUM 
...
AND ST1.GEO_USPS_STATE_CD IN ('CO','DE','FL','GA','IN','MO','NM','OK','PA','TX','WV' )
