...
COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ108_SUNPHARMS_2018_CAR_20260304.120000.csv.gz FROM (

          SELECT 
               'START'
              ,RPAD(C.CLM_TYPE_CD,5,' ')                 AS CLM_TYPE_CD
		...
		-- 1/1/2018 through present; new file for each year
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2018-01-01','YYYY-MM-DD') AND TO_DATE('2018-12-31','YYYY-MM-DD')

		AND CL.CLM_LINE_HCPCS_CD IN ('96573', '96574','96567', 'J7308')
                 

)

		   FILE_FORMAT = (TYPE = CSV field_delimiter = ","  ESCAPE_UNENCLOSED_FIELD=NONE FIELD_OPTIONALLY_ENCLOSED_BY = '"' )
			SINGLE=TRUE  HEADER=TRUE max_file_size=5368709120         



COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ108_SUNPHARMS_2019_CAR_20260304.120000.csv.gz FROM (
		...
		AND C.CLM_FINL_ACTN_IND = 'Y'
		-- 1/1/2018 through present; new file for each year
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2019-01-01','YYYY-MM-DD') AND TO_DATE('2019-12-31','YYYY-MM-DD')
...
COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ108_SUNPHARMS_2020_CAR_20260304.120000.csv.gz FROM (
		...
		AND C.CLM_FINL_ACTN_IND = 'Y'
		-- 1/1/2018 through present; new file for each year
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2020-01-01','YYYY-MM-DD') AND TO_DATE('2020-12-31','YYYY-MM-DD')
...
COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ108_SUNPHARMS_2021_CAR_20260304.120000.csv.gz FROM (
		...
		AND C.CLM_FINL_ACTN_IND = 'Y'
		-- 1/1/2018 through present; new file for each year
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2021-01-01','YYYY-MM-DD') AND TO_DATE('2021-12-31','YYYY-MM-DD')
...
COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ108_SUNPHARMS_2022_CAR_20260304.120000.csv.gz FROM (
		...
		AND C.CLM_FINL_ACTN_IND = 'Y'
		-- 1/1/2018 through present; new file for each year
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2022-01-01','YYYY-MM-DD') AND TO_DATE('2022-12-31','YYYY-MM-DD')
...
COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ108_SUNPHARMS_2023_CAR_20260304.120000.csv.gz FROM (
		...
		AND C.CLM_FINL_ACTN_IND = 'Y'
		-- 1/1/2018 through present; new file for each year
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2023-01-01','YYYY-MM-DD') AND TO_DATE('2023-12-31','YYYY-MM-DD')
...
COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ108_SUNPHARMS_2024_CAR_20260304.120000.csv.gz FROM (
		...
		AND C.CLM_FINL_ACTN_IND = 'Y'
		-- 1/1/2018 through present; new file for each year
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2024-01-01','YYYY-MM-DD') AND TO_DATE('2024-12-31','YYYY-MM-DD')
...
COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ108_SUNPHARMS_2025_CAR_20260304.120000.csv.gz FROM (
		...
		AND C.CLM_FINL_ACTN_IND = 'Y'
		-- 1/1/2018 through present; new file for each year
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2025-01-01','YYYY-MM-DD') AND TO_DATE('2025-12-31','YYYY-MM-DD')
...
COPY INTO @BIA_PRD.CMS_STAGE_XTR_PRD.BIA_PRD_XTR_DOJ_STG/DOJ_SFUI_REQ108_SUNPHARMS_2026_CAR_20260304.120000.csv.gz FROM (
		...
		AND C.CLM_FINL_ACTN_IND = 'Y'
		-- 1/1/2018 through present; new file for each year
		AND CL.CLM_LINE_FROM_DT BETWEEN TO_DATE('2026-01-01','YYYY-MM-DD') AND TO_DATE('2026-12-31','YYYY-MM-DD')
